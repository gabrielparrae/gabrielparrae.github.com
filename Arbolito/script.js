...
(function () {
    ...
    for (let a = 0; a < r; a++) {
        ...
        n = new THREE.Color("red");
            ...
            let colors = ["#ff0000", "#ffd700", "#00ff00", "#0000ff", "#800080", "#ff69b4", "#00ffff"];
            n = new THREE.Color(colors[Math.floor(Math.random() * colors.length)]);
            n.multiplyScalar(1.5);
        } else if ("sphere" == o) {
            let e = ["white", "red"];
    ...
    document.body.appendChild(u),
        ((T = new THREE.Scene()).background = null),
        (T.environment = h),
